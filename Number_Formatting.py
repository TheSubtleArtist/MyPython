...
def printNumberInputFormats(number):
...
if __name__ == '__main__':
    printNumberInputFormats(int(input("Input a number between 10 and 20:  ")))
    print("Here are some other examples of number formats using the number 42: ")
